...
# gemma_4galaxy (128 ASICs: eight 4x4 RING/RING, 1 host [1,1] + 7 host [1,4]) and the two-4x4
# single-galaxy MGD (M0->Middle / M1->Edge pinned), mapped across all SC4 subtorus quad mocks.
for mock in \
