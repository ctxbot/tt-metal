...
// reports the scope-table entry and value(). Read-only by construction -- the census access
// scan proves it, which is what lets a sole remote sender take the posted-write fast path.
