...
bool fabric2d_ring_uses_non_neighbor_directions(
    const Tensor& input_tensor, uint32_t axis, tt::tt_fabric::Topology axis_topology) {
...
AllGatherDeviceOperation::program_factory_t AllGatherDeviceOperation::select_program_factory(
    ...
    if (args.is_true_2d()) {
        ...
        if (tt::tt_fabric::is_2d_fabric_config(args.fabric_config) &&
            ...
            fabric2d_ring_uses_non_neighbor_directions(input_tensor, axis, args.axis_topology[axis])) {
