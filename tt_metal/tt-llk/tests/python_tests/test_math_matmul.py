...
def test_math_matmul(
    ...
    # 16x32 tiny-tile section that used dest tiles 9+ leaves packer dest
    # addressing stuck at tile 8 on the next section. Skip the 4-block handoff
    # for those shapes; ct_dim<=8 SyncFull and SyncHalf still cover it.
    ...
    dest_spans_second_half = (
        ...
        and matmul_config.tile_dimensions.in0_tile_r_dim == 16
