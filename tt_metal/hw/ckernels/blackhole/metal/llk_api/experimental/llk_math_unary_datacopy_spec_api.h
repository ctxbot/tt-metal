...
/*************************************************************************
 * LLK ELTWISE UNARY DATACOPY -- L1MetaData (id-free, compile-time NTTP) overloads
 *
 * Same function names as the CB-id API (llk_math_eltwise_unary_datacopy / _init), distinguished by
 * taking an L1Descriptor as the first NTTP. MATH never touches L1, so DESC (format + geometry) is all
