 ...
 * Compute API. Every parameter is required: the template overload above covers the shorter argument
 * lists, so a 6-argument call resolves here unambiguously and a 3-to-5-argument call resolves there.
 *
 * @param operandA: The input0 operand circular buffer
 * @param operandB: The input1 operand circular buffer
